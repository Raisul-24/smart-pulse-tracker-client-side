   ...
   return (
      ...
      <div className="footer p-10 bg-neutral text-neutral-content">
         <aside className="flex items-center">
            <img src="/logo.jpeg" className="w-16 h-16 rounded-full" />
            <p>SmartPulse Tracker Ltd.<br />Providing reliable tech since 2023</p>
         </aside>
         <nav>
      ...
      <div className="footer footer-center p-4 bg-base-300 text-base-content">
            <aside>
               <p>Copyright © 2023 - All right reserved by SmartPulse Tracker Ltd</p>
            </aside>
         </div>
   </footer>
   );
