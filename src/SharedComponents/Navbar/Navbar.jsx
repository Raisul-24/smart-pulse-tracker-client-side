...
const Navbar = () => {
   ...
   return (
      <div className="navbar fixed z-10 bg-opacity-30 max-w-screen-2xl bg-black ">
         <div className="navbar-start">
            ...
            <Link to='/' className="btn btn-ghost normal-case text-xl">SmartPulse<span>Tracker</span></Link>
         </div>
